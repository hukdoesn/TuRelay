...
// 配置 axios
axios.defaults.baseURL = 'http://192.168.5.31:8100'; // 根据后端服务地址修改
...
app.config.globalProperties.$wsServerAddress = 'ws://192.168.5.31:8100';

// app.config.globalProperties.$wsServerAddress = 'ws://192.168.5.82:8081/guacamole';
// app.config.globalProperties.$guacamoleUrl = 'http://172.17.103.22:8081/guacamole';
app.config.globalProperties.$guacamoleUrl = 'http://192.168.5.31:8081/guacamole';
