...
ALLOWED_HOSTS = ['172.17.103.237', 'localhost', '192.168.5.29', '192.168.222.86', '127.0.0.1']  # 添加允许的主机名

# Guacamole 服务器配置
GUACAMOLE_URL = 'http://172.17.103.237:8081/guacamole'  # Guacamole 服务器的 URL，需根据实际情况修改
