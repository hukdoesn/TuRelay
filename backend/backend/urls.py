...
urlpatterns = [
    ...
    path('api/users/current/', UserDetailView.as_view(), name='current-user'),
    path('api/users/current/reset_password/', UserDetailView.as_view(), name='current-user-reset-password'),
