...
from apps.views import LoginView, check_permission, UserListView, RolesPermissionsView, CreateUserView, UserUpdateView, LoginLogView, UserDetailView
...
urlpatterns = [
    ...
    path('api/users/<str:username>/', UserDetailView.as_view(), name='user-detail'),  # 配置删除用户和获取用户详细信息的API路径
